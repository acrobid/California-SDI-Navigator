  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600 dark:text-gray-400">
        Important contacts for navigating your CA SDI claim and Hartford LTD
        coordination.
      </p>
    </div>
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <span class="text-green-700 dark:text-green-300"
                    >Best time: {{ contact.bestTimeToCall }}</span
                  >
                </div>
