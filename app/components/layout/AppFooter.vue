...
<template>
  <footer class="border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 mt-auto">
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
          <NuxtLink to="/about" class="hover:text-primary-600 dark:hover:text-primary-400">
            About
          </NuxtLink>
          <span>Last Updated: January {{ currentYear }}</span>
        </div>
      </div>
    </div>
  </footer>
