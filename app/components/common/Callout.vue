...
const variantClasses: Record<Variant, string> = {
  ...
  danger: 'bg-red-50 border-red-500 text-red-900 dark:bg-red-950 dark:text-red-100',
  tip: 'bg-green-50 border-green-500 text-green-900 dark:bg-green-950 dark:text-green-100',
  important: 'bg-purple-50 border-purple-500 text-purple-900 dark:bg-purple-950 dark:text-purple-100',
}
...
<template>
  <div :class="['my-4 p-4 rounded-lg border-l-4', variantClasses[props.variant]]">
    <div class="flex items-start gap-3">
      <UIcon :name="iconMap[props.variant]" class="w-5 h-5 mt-0.5 flex-shrink-0" />
      <div class="flex-1">
