...
1. **pilot.fedex.com** - Company pilot portal
2. **PRISM** - Scheduling and bid system
3. **Company email** - Your @fedex.com email address
...
::callout{type="info" title="Your Right to Access"}
Company system access during disability is not a courtesy—it's a contractual right. If access is denied or lost, take immediate action to restore it.
::
