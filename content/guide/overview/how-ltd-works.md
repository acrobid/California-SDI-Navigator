...
::callout{type="warning" title="Claims Administrator"}
The CBA Section 27.J references **Aetna Life Insurance Company** as the claims administrator. However, some documentation references The Hartford. Verify the current administrator with FedEx Benefits Service Center (1-855-545-4748) before filing. See [Contacts](/contacts) for more information.
::
...
::callout{type="info" title="Important Limits"}
...
**See [Benefit Calculation Guide](/guide/hartford/calculation) for complete details.**
...
::callout{type="info" title="Not Just Time-Based"}
Unlike many LTD plans, the FedEx plan does NOT begin simply after 180 days. You must meet one of the eligibility triggers. See [LTD Eligibility](/guide/hartford/eligibility) for complete details.
::

## Offsets (CBA Sections 27.J.13, 27.J.15)

::callout{type="danger" title="Critical Concept"}
...
**See [Comprehensive Offset Guide](/guide/hartford/offsets) for details and examples.**
...
**See [Cooperation Requirements](/guide/hartford/cooperation) for complete details.**
...
**See [Duration Limits](/guide/hartford/duration) for complete details.**
...
2. Contact the administrator (see [Contacts](/contacts))
...
::callout{type="danger" title="6-Month Deadline"}
...
**See [Company System Access](/guide/hartford/company-access) for details.**
...
- **[LTD Eligibility](/guide/hartford/eligibility)** - When LTD actually begins
- **[Benefit Calculation](/guide/hartford/calculation)** - Detailed calculation method
- **[Offset Rules](/guide/hartford/offsets)** - Complete offset information
- **[The Offset Problem](/guide/overview/offset-problem)** - Why CA pilots face unique challenges
- **[Calculator](/calculator)** - Estimate your LTD and offset amounts
