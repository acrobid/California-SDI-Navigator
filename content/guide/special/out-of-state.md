...
::callout{type="info" title="Residency Not Required"}
...
::callout{type="warning" title="No California ID? File by Mail"}
...
1. Order it online from the [EDD Forms and Publications](https://edd.ca.gov/en/disability/Forms_and_Publications/) page.
...
::callout{type="warning" title="Short Mail Deadlines Are Common"}
...
::callout{type="warning" title="Tax Advice"}
...
- [Filing Methods](/guide/filing/filing-methods) - How to file remotely
- [Tracking Your Claim](/guide/post-filing/tracking) - Monitor from anywhere
- [Contacts](/contacts) - EDD phone numbers and resources
