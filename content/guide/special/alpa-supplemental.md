---
title: "ALPA Supplemental Disability Plan"
...
::callout{type="info" title="Independent Coverage"}
...
✅ **Can share:** Medical records and documentation
✅ **Reduces:** Duplicate paperwork requests
✅ **Saves time:** Don't need to submit same documents twice

❌ **Cannot affect:** Approval decisions on either plan
❌ **No guarantee:** Approval on one doesn't mean approval on other
❌ **Independent:** Each plan decides separately
...
::callout{type="info" title="Additive Benefits"}
...
::callout{type="info" title="Independent Expert Advice"}
