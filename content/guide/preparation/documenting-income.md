...
You need pay stubs covering your entire base period plus some buffer:
...
```
╔══════════════════════════════════════════════════════╗
║  QUARTERLY INCOME - BASE PERIOD                      ║
║  For Claim Filed: [Month/Year]                       ║
║  Base Period: [Start] to [End]                       ║
╠══════════════════════════════════════════════════════╣
║  Quarter        | Total Wages    | Notes            ║
║  ---------------|----------------|------------------ ║
║  Q1 (Jan-Mar)   | $85,000        | Full schedule    ║
║  Q2 (Apr-Jun)   | $92,000        | ← HIGHEST        ║
║  Q3 (Jul-Sep)   | $78,000        | Vacation month   ║
...
- [Sick Bank Strategy](/guide/preparation/sick-bank-strategy) - Managing your time off banks
- [What to Save Now](/guide/preparation/what-to-save) - Other important documents
- [Calculator](/calculator) - Calculate your expected benefit
